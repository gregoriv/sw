...
####Τίτλος δραστηριότητας: Playing with the car
...
:arrow_right:      Screen 1

-Μεταβάλλουμε τις ιδιότητες		
:arrow_right:	     Screen Orientation: Portrait
...
Κάθε φορά που το χρονόμετρο μετράει τέσσερα δευτερόλεπτα η σημαία θα μετακινείται σε μια νέα τυχαία θέση.
...
και θα αλλάξουμε την ταχύτητα και την κατεύθυνση του γραφικού του αυτοκινήτου ανάλογα με τα μεγέθη Angle (γωνιά) και Magnitude (μέγεθος) του αισθητήρα.
...
##Παραδοτέο 4
### Βελτιώσεις
Προσθέσαμε σκόπο, στόχους, εικόνες και κάποιες επεκτάσεις. Έτσι η τελική αναφορά διαμορφώνεται ως εξής:
